...
export const Nav = ({isDesktop, lng, setMenuOpen, showSettings, showAnnouncements, setShowSettings, setShowAnnouncements}: {isDesktop: boolean, lng: string, setMenuOpen: React.Dispatch<React.SetStateAction<boolean>>, showSettings: boolean, showAnnouncements: boolean, setShowSettings: React.Dispatch<React.SetStateAction<boolean>>, setShowAnnouncements: React.Dispatch<React.SetStateAction<boolean>>}) => {
    const { accounts, currentAccount, switchAccount, addNewAccount, logOut} = useAppState();
