...
function App() {
  ...
  const possibleGroups = ["1a","1b","1c","1d","1s","1k","1l","1m","1f","1g","2a","2b","2c","2d","2s","2k","2l","2m","2f","2g","3h","3v","4v","5v","5h","6v"];
  ...
  useEffect(() => {
    ...
    const fetchData = async() => {
      ...
      const announcementsRes: Announcements = await getAnnouncements(school, token);
